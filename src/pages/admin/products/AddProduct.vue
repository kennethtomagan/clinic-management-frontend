            ...
            <div class="row q-col-gutter-md">
              ...
              <div class="col-12 col-md-4">
                <div class="image-upload-container">
                    <q-img
                        :src="product.image_url || 'https://via.placeholder.com/300?text=Product+Image'"
                    ...
                    <template v-slot:append v-if="product.image">
...
const saveProduct = () => {
  ...
  loading.value = true
    ...
    storeProduct.addProduct(product).then((response) => {
        loading.value = false
        $q.notify({
