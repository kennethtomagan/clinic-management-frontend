  ...
  <q-layout view="lHh Lpr lFf">
    ...
    >
      <q-list>
        ...
        <q-item to="/admin/patients" active-class="q-item-no-link-highlighting">
          <q-item-section avatar>
        ...
        <q-item to="/admin/doctors" active-class="q-item-no-link-highlighting">
          <q-item-section avatar>
...
<!-- 
        <q-item to="/admin/profile" active-class="q-item-no-link-highlighting">
          <q-item-section avatar>
...
const isPatientsDashboard = computed(() => {
  return route.name === 'admin.dashboard' || route.path === '/admin/dashboard'
})
